...
DECLARE_MODULE_V1
(
	"freenode/cs_successor_abandoned", false, _modinit, _moddeinit,
	"$Id: cs_successor_abandoned.c 65 2012-06-09 12:25:31Z stephen $",
...
static void channel_pick_successor_hook(hook_channel_succession_req_t *req)
{
	 ...
	 */
	req->mu = myuser_find("AbandonedChannel");
}
