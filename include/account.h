...
E kline_t *kline_add_with_id_auto(const char *user, const char *host, const char *reason, long duration, const char *setby, unsigned long id);
E kline_t *kline_add_auto(const char *user, const char *host, const char *reason, long duration, const char *setby);
